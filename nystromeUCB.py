...
#     query_features=intent_features
    ...
    query_features = pickle.load(open('./data/msmacro/X_question_tfidf.pkl','rb'))
    page_features=pickle.load(open('./data/msmacro/X_page_tfidf.pkl','rb'))
    
    test_query_features= pickle.load(open('./data/msmacro/X_question_tfidf.pkl','rb'))

    ratings = pickle.load(open('./data/msmacro/X_ass_mat.pkl','rb'))
    test_ratings = pickle.load(open('./data/msmacro/X_ass_mat.pkl','rb'))
    
    K_pc_500 = pickle.load(open('./data/msmacro/K_arm_rbf_04_500.pkl','rb'))
